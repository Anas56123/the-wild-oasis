...
export default function Home() {
  ...
  return (
    <div className="transition-colors duration-500 h-screen flex justify-center items-center dark:text-slate-50">
      <div className="transition-colors duration-500 h-5/6 w-2/6 rounded-xl flex justify-center items-center flex-col bg-slate-50 dark:bg-slate-900 px-20">
        <h1 className="transition-colors duration-500 text-4xl font-bold dark:text-slate-50">
          Sign up
        </h1>
        <br />
        <form onSubmit={handleSubmit}>
          <div className="transition-colors duration-500 flex justify-center flex-col">
            <label className="transition-colors duration-500 font-bold text-lg dark:text-slate-50">
              Email:
            </label>
            <input
