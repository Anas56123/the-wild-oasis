        ...
        return (
          <>
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className={`transition-colors duration-300 w-6 h-6 hover:text-indigo-500 text-slate-500 ${pathName == this.href || mouseClick == this.bg ? "text-indigo-500" : "text-slate-500"}`}
            >
              <path
            ...
            {linkList.map((link, index) => {
              return (
                <Link
                  ...
                  key={index}
                  onClick={() => {
                    setMouseClick(link.bg);
                  }}
                  onMouseEnter={() => setMouseClick(link.bg)}
                  onMouseLeave={() => setMouseClick("")}
                  className={`transition-colors duration-300 flex items-center rounded-lg py-3 px-6 gap-3 text-md ${
                    mouseClick == link.bg ? "bg-slate-50 dark:bg-slate-900" : ""
                  }`}
                >
                  {link.icon()}
