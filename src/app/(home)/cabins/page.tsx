    ...
    <ClientOnly>
      <div className="transition-colors duration-500 flex flex-col items-center dark:text-slate-50">
        ...
        <div className="transition-colors duration-500 w-5/6 flex justify-between items-center">
          ...
          <div className="transition-colors duration-500 border-slate-50 dark:border-slate-800 border bg-wihte w-80 rounded flex justify-between px-1 bg-slate-50 dark:bg-[#18212f]">
            <button
